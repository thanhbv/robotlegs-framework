...
*Fixing SwiftSuspenders Mapping Warnings in the Context*
Main injector mappings now unmapped when `set contextView` runs.
Added protected 'unmapInjections' method.
Updated to SS 1.6 (which has warnings on mapping-overwrite).
Still works with SS 1.5.1
